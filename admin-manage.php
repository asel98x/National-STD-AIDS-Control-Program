...
?>
    ...
    <?php
        ...
        function getData()
        {
            ...
            $data[7]=$_POST['NIC'];
            $data[8]=$_POST['Age'];
            $data[9]=$_POST['Username'];
            $data[10]=$_POST['Password'];
            $data[11]=$_POST['role'];
        
            return $data;
        }
        
        //insert insert into for table admin)
            ...
            !empty ($_POST['Address']) && !empty ($_POST['Mobile']) && !empty ($_POST['Birthday']) &&
             !empty ($_POST['NIC']) && !empty ($_POST['Age']) && !empty ($_POST['Username']) &&
              !empty ($_POST['Password'])){
                ...
                $info = getData();
            $insert_query="INSERT INTO `admin`(`First_name`, `Last_name`, `gender`, `Address`, `Mobile`, `Birthday`, `NIC`, `Age`, `Username`, `Password`) VALUES ('$info[1]','$info[2]','$info[3]','$info[4]', '$info[5]','$info[6]','$info[7]','$info[8]', '$info[9]','$info[10]')";
        ...
        if(isset($_POST['insert'])){
             ...
             if(!empty ($_POST['role'])){
                $info = getData();
                 $insert_query="INSERT INTO `users`(`role`, `Username`, `Password`, `name`) VALUES ('$info[11]','$info[9]', '$info[10]','$info[1]')";
        ...
        if(isset($_POST['update'])){
            $info = getData();
            $update_query="UPDATE `admin` SET `First_name`='$info[1]',Last_name='$info[2]',Address='$info[4]', Mobile='$info[5]', Birthday='$info[6]', NIC='$info[7]', Age='$info[8]', Username='$info[9]', Password='$info[10]' WHERE id = '$info[0]'";
